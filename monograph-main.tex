...
% =================================================================
% SUMÁRIO (OBRIGATÓRIO EM MONOGRAFIAS)
% =================================================================
\tableofcontents
\newpage
...
% Opção B2 — biblatex + biber: configure no config/monograph-config.tex
% (descomente o \usepackage[backend=biber]{biblatex} e o \addbibresource{...})
% e então descomente abaixo para imprimir a bibliografia.
% \printbibliography

% Índice remissivo e glossário (se habilitados em config/monograph-config.tex)
% \printglossaries
% \printindex
